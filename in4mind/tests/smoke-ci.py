...
assert_("UiDialog module", "function confirm" in read("src/js/services/UiDialog.js"))
assert_("UserScopedStorage module", "function accountId" in read("src/js/services/UserScopedStorage.js"))
assert_("notes tombstones", "deletedNotes" in read("src/js/services/NotesService.js"))
assert_("CloudBlobSync tombstones", "deletedMap" in read("src/js/services/CloudBlobSync.js"))
assert_("Gamification scoped", "UserScopedStorage" in read("src/js/services/GamificationService.js"))
