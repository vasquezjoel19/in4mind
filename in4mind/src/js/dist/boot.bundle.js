/*! IN4MIND bundle 20260820ux1 — 2026-08-20T20:31:57.734401+00:00 */
...
const LOCALE_ZH = {
  ...
  notes: {
    ...
    renameFolder: '重命名',
    folderOptions: '文件夹选项',
    deleteFolderConfirm: '删除此文件夹及其内的所有笔记？文件夹外的笔记会保留。你可以在几秒内撤销。',
