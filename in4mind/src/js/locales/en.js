...
const LOCALE_EN = {
  ...
  ai: {
    ...
    errTooFast: '**Slow down**\n\nWait {wait} before sending another question. The limit keeps the service running for everyone.',
    errDailyQuota: '**Daily limit reached**\n\nYou have used your {limit} questions for today. You can continue in {wait}. Courses and quizzes are still available.',
  ...
  cookies: {
    bannerTitle: 'Cookies',
    bannerText: 'We use cookies and local storage to remember preferences and improve your experience.',
