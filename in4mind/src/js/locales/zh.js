...
const LOCALE_ZH = {
  ...
  ai: {
    ...
    errTooFast: '**请稍慢一些**\n\n请等待 {wait} 再发送下一个问题。此限制是为了让所有人都能正常使用。',
    errDailyQuota: '**已达每日上限**\n\n你今天的 {limit} 次提问已用完，{wait} 后可继续。课程和测验仍然可用。',
    waitSeconds: '{n} 秒',
    waitMinutes: '{n} 分钟',
    waitHours: '{n} 小时',
  ...
  privacy: {
    ...
    deleteBtn: '删除',
    deleteConfirm: '确定删除本地所有数据并退出登录吗？此操作无法撤销。',
    exportData: '导出我的数据',
