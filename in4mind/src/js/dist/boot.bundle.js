...
const LOCALE_ES = {
  ...
  employable: {
    sectionTitle: 'Ruta Empleable',
    sectionSub: 'Progreso hacia tus 3 entregables de portfolio: proyecto, certificado y pitch.',
    eyebrow: 'Ruta Empleable IN4MIND',
    heroTitle: 'De curso completado a evidencia para empleo',
    banner: 'No solo aprendes: sales con proyecto real, certificado verificable y perfil listo para aplicar.',
    coreHook: 'Crea un proyecto real, obtén tu certificado verificable y sal con tu perfil listo para trabajar.',
    portfolioProgress: 'Progreso del portfolio',
    deliverables: 'entregables',
    modalTitle: 'Ruta Empleable',
    projectLabel: 'URL del proyecto final',
    submitProject: 'Enviar proyecto y emitir certificado',
    projectSaved: 'Proyecto guardado y certificado emitido',
    certReady: 'Certificado verificable',
    openVerify: 'Abrir verificación pública',
    generatePitch: 'Generar pitch / CV / entrevista con IA',
    copyCv: 'Copiar CV',
    copyLinkedin: 'Copiar LinkedIn',
    downloadTxt: 'Descargar .txt',
    downloadMd: 'Descargar .md',
    copied: 'Copiado',
    copyFail: 'No se pudo copiar',
    urlSoftWarn: 'Asegúrate de que sea un enlace público válido.',
    checklistTitle: 'Pasos de la ruta',
    checklist: {
      lessons: 'Completar lecciones',
      build: 'Crear proyecto',
      link: 'Pegar enlace',
      cert: 'Descargar certificado',
      cv: 'Generar CV',
    },
    reviewBtn: 'Revisar proyecto con IA (rúbrica junior)',
    reviewScore: 'Puntaje: {score}/100',
    ...
    previewBtn: 'Vista previa del proyecto',
    previewHint: 'Revisa la vista previa antes de emitir el certificado.',
    previewReady: 'Vista previa lista — confirma para emitir certificado',
    previewRequired: 'Primero revisa la vista previa del proyecto',
    previewNoEmbed: 'Este sitio no permite incrustar vista previa. Abre el enlace para verificarlo.',
    previewOpen: 'Abrir proyecto',
    previewTrusted: 'Dominio conocido',
    previewUntrusted: 'Revisa que sea público',
    reqAuto: 'auto',
    cvTitle: 'Bullets de CV',
    liHeadline: 'LinkedIn — titular',
    liSummary: 'LinkedIn — resumen',
    interviewTitle: '5 preguntas de entrevista',
    continue: 'Continuar entregables',
    choose: 'Elegir esta ruta',
    openPanel: 'Ver entregables',
    thisCourseIn: 'Este curso forma parte de: {path}',
    gateMsg: 'Aprendizaje casi listo: la ruta no se marca al 100% hasta enviar el proyecto final.',
    gateShort: 'Falta proyecto final',
    invalidUrl: 'URL inválida. Usa http:// o https://',
    needProjectFirst: 'Envía el proyecto antes de continuar',
    deliverable: {
      project: 'Proyecto real',
      projectHint: 'Envía la URL de tu proyecto final',
      certificate: 'Certificado verificable',
      certHint: 'Se emite al validar el proyecto',
      pitch: 'Pitch / CV / entrevista',
      pitchHint: 'Genera tu pitch con IA',
      pitchReady: 'Perfil listo para aplicar',
    },
    paths: {
      'web-junior': {
        title: 'Web Junior',
      ...
      'data-analyst-jr': {
        ...
        tagline: 'Sal con un dashboard público y narrativa de datos.',
      },
  ...
  signupOnboard: {
    ...
    goals: {
      ...
      web: {
        title: 'Web Junior (Ruta Empleable)',
        desc: 'HTML/CSS, JS y GitHub hasta un proyecto desplegado.',
      },
      'data-career': {
        title: 'Analista de datos Jr',
        desc: 'Excel, SQL y Power BI hacia un dashboard publicable.',
      },
      'office-automation': {
        title: 'Office 365 & Automatización',
        desc: 'Power Apps, SharePoint y flujos listos para demostrar.',
      },
      design: {
        title: 'Diseño',
  ...
  cert: {
    ...
    project: 'Proyecto',
    path: 'Ruta',
    employableTitle: 'Certificado Ruta Empleable',
  },
  video: {
  ...
  profile: {
    ...
    emptyCert: 'Aún no tienes certificaciones. Completa quizzes, exámenes o una Ruta Empleable.',
    ...
    emptyActionCerts: 'Ir a Ruta Empleable',
    filterAll: 'Todas',
    continue: 'Continuar',
    seeMore: 'Ver más',
    open: 'Abrir',
    ...
    employableCert: 'Ruta Empleable',
    employableCertDesc: 'Proyecto real + certificado verificable',
    viewExam: 'Ver examen',
    viewQuiz: 'Ver quiz',
    viewEmployable: 'Ver verificación',
  ...
  landing: {
    ...
    introBody: 'Proyecto real, certificado verificable y perfil listo para trabajar — con cursos, quizzes e IA.',
...
const LOCALE_EN = {
  ...
  employable: {
    sectionTitle: 'Job-Ready Path',
    sectionSub: 'Progress toward your 3 portfolio deliverables: project, certificate, and pitch.',
    eyebrow: 'IN4MIND Job-Ready Path',
    heroTitle: 'From course completion to job evidence',
    banner: 'You don’t just learn — you leave with a real project, a verifiable certificate, and an application-ready profile.',
    coreHook: 'Build a real project, get a verifiable certificate, and leave job-ready.',
    portfolioProgress: 'Portfolio progress',
    deliverables: 'deliverables',
    modalTitle: 'Job-Ready Path',
    projectLabel: 'Final project URL',
    submitProject: 'Submit project and issue certificate',
    projectSaved: 'Project saved and certificate issued',
    certReady: 'Verifiable certificate',
    openVerify: 'Open public verification',
    generatePitch: 'Generate pitch / CV / interview with AI',
    copyCv: 'Copy CV',
    ...
    urlSoftWarn: 'Make sure it is a valid public link.',
    checklistTitle: 'Path steps',
    checklist: {
    ...
    reviewBtn: 'Review project with AI (junior rubric)',
    reviewScore: 'Score: {score}/100',
    ...
    next: {
      ...
      cert: 'Open your {path} certificate',
    ...
    previewBtn: 'Project preview',
    previewHint: 'Review the preview before issuing the certificate.',
    previewReady: 'Preview ready — confirm to issue the certificate',
    previewRequired: 'Review the project preview first',
    previewNoEmbed: 'This site blocks embedded preview. Open the link to verify it.',
    previewOpen: 'Open project',
    previewTrusted: 'Known domain',
    previewUntrusted: 'Check it is public',
    reqAuto: 'auto',
    cvTitle: 'CV bullets',
    liHeadline: 'LinkedIn — headline',
    liSummary: 'LinkedIn — summary',
    interviewTitle: '5 interview questions',
    continue: 'Continue deliverables',
    choose: 'Choose this path',
    openPanel: 'View deliverables',
    thisCourseIn: 'This course is part of: {path}',
    gateMsg: 'Learning is almost ready: the path stays under 100% until you submit the final project.',
    gateShort: 'Final project required',
    invalidUrl: 'Invalid URL. Use http:// or https://',
    needProjectFirst: 'Submit the project before continuing',
    deliverable: {
      project: 'Real project',
      projectHint: 'Submit your final project URL',
      certificate: 'Verifiable certificate',
      certHint: 'Issued when the project is validated',
      pitch: 'Pitch / CV / interview',
      pitchHint: 'Generate your pitch with AI',
      pitchReady: 'Profile ready to apply',
    },
    paths: {
      'web-junior': {
        title: 'Web Junior',
      ...
      'data-analyst-jr': {
        ...
        tagline: 'Ship a public dashboard and a data story.',
      },
      'office365-automation': {
  ...
  signupOnboard: {
    ...
    goals: {
      ...
      web: {
        title: 'Web Junior (Job-Ready Path)',
        desc: 'HTML/CSS, JS, and GitHub through a shipped project.',
      },
      'data-career': {
        title: 'Jr Data Analyst',
        desc: 'Excel, SQL, and Power BI toward a publishable dashboard.',
      },
      'office-automation': {
        title: 'Office 365 & Automation',
        desc: 'Power Apps, SharePoint, and demo-ready workflows.',
      },
      design: {
        title: 'Design',
  ...
  cert: {
    ...
    project: 'Project',
    path: 'Path',
    employableTitle: 'Job-Ready Path certificate',
  },
  video: {
  ...
  profile: {
    ...
    emptyCert: 'No certifications yet. Complete quizzes, exams, or a Job-Ready Path.',
    ...
    emptyActionCerts: 'Go to Job-Ready Path',
    filterAll: 'All',
    continue: 'Continue',
    seeMore: 'See more',
    open: 'Open',
    ...
    employableCert: 'Job-Ready Path',
    employableCertDesc: 'Real project + verifiable certificate',
    viewExam: 'View exam',
    viewQuiz: 'View quiz',
    viewEmployable: 'View verification',
  ...
  landing: {
    ...
    introBody: 'Real project, verifiable certificate, and an application-ready profile — with courses, quizzes, and AI.',
    backTop: 'Back to top',
...
const LOCALE_ZH = {
  ...
  employable: {
    ...
    previewBtn: '项目预览',
    previewHint: '颁发证书前请先预览项目。',
    previewReady: '预览就绪 — 确认后颁发证书',
    previewRequired: '请先查看项目预览',
    previewNoEmbed: '该站点无法嵌入预览。请打开链接核实。',
    previewOpen: '打开项目',
    previewTrusted: '已知域名',
    previewUntrusted: '请确认可公开访问',
    reqAuto: '自动',
    cvTitle: '简历要点',
