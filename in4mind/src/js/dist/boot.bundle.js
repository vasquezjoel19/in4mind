/*! IN4MIND bundle 20260813bundle — 2026-08-13T18:47:29.379736+00:00 */
...
const LOCALE_ZH = {
  ...
  ai: {
    ...
    localMode: '本地模式 — 请在 groq.config.js 中配置 API Key',
    assistantReady: '教育助手已就绪',
    generating: '生成回复中…',
    error: '请求错误',
    errNoKey: '**需要配置**\n\n要启用 Groq AI，请打开 `src/js/config/groq.config.js` 并填入 Groq API Key。\n\n- 在 https://console.groq.com/keys 获取密钥\n- 若尚无该文件，请将 `groq.config.example.js` 复制为 `groq.config.js`',
    ...
    configBanner: '请在 src/js/config/groq.config.js 中配置 Groq API Key 以启用生成式 AI 回复。',
    conversations: '对话',
    roleUser: '您',
    roleAi: 'IN4MIND 助手',
    roleIa: 'AI',
