...
const CourseCurriculum = (() => {
  ...
  const DATA = {
    ...
    html: {
      ...
      quizSections: [
        { title: 'Estructura base HTML5', questions: [{ type: 'choice', q: '¿Qué elemento define metadatos no visibles al usuario pero críticos para render y SEO?', opts: ['body', 'head', 'main', 'footer'], ans: 1, exp: 'head encapsula metadatos de documento.' }, { type: 'truefalse', q: 'El doctype correcto ayuda a que el navegador use modo estándar.', ans: true, exp: 'Evita render inconsistente entre motores.' }, { type: 'match', q: 'Relaciona etiqueta y propósito:', pairs: [{ left: '<html>', right: 'Raíz del documento' }, { left: '<head>', right: 'Metadatos de la página' }, { left: '<body>', right: 'Contenido visible' }, { left: '<title>', right: 'Título de pestaña y SEO base' }], exp: 'Una base sólida garantiza compatibilidad.' }] },
        { title: 'Contenido semántico y jerarquía', questions: [{ type: 'choice', q: '¿Qué error semántico afecta más comprensión de lectores de pantalla?', opts: ['Usar CSS externo', 'Saltar jerarquías de encabezados sin lógica', 'Incluir un footer', 'Usar listas ordenadas'], ans: 1, exp: 'La jerarquía guía navegación asistiva.' }, { type: 'truefalse', q: 'article debe usarse para contenido autónomo con sentido por sí mismo.', ans: true, exp: 'Su semántica indica independencia del bloque.' }, { type: 'match', q: 'Relaciona etiqueta y función:', pairs: [{ left: '<nav>', right: 'Enlaces de navegación principal' }, { left: '<section>', right: 'Agrupar contenido temático' }, { left: '<article>', right: 'Unidad de contenido independiente' }, { left: '<aside>', right: 'Contenido complementario' }], exp: 'La semántica mejora estructura y mantenimiento.' }] },
        { title: 'Enlaces, multimedia y listas', questions: [{ type: 'choice', q: '¿Qué práctica mejora seguridad al abrir enlaces externos en nueva pestaña?', opts: ['target="_blank" sin más', 'Agregar rel="noopener noreferrer"', 'Quitar atributo href', 'Convertir enlace en botón sin función'], ans: 1, exp: 'Previene acceso del destino al contexto original.' }, { type: 'truefalse', q: 'El atributo alt debe describir la función informativa de la imagen.', ans: true, exp: 'No es opcional en imágenes con valor de contenido.' }, { type: 'match', q: 'Relaciona elemento y uso correcto:', pairs: [{ left: '<a>', right: 'Navegación entre recursos' }, { left: '<img>', right: 'Mostrar imagen con texto alternativo' }, { left: '<ul>', right: 'Lista sin orden de prioridad' }, { left: '<ol>', right: 'Secuencia con orden explícito' }], exp: 'Los elementos deben corresponder al significado del contenido.' }] },
        { title: 'Formularios accesibles', questions: [{ type: 'choice', q: '¿Qué combinación mejora usabilidad y validación básica en correo electrónico?', opts: ['input type="text"', 'input type="email" + label asociado', 'placeholder sin label', 'div con contenteditable'], ans: 1, exp: 'El tipo correcto habilita validación y teclado optimizado.' }, { type: 'truefalse', q: 'Un placeholder no reemplaza a un label accesible.', ans: true, exp: 'El label mantiene contexto persistente.' }, { type: 'match', q: 'Relaciona componente y beneficio:', pairs: [{ left: 'label for', right: 'Asociación explícita campo-texto' }, { left: 'required', right: 'Validación nativa mínima' }, { left: 'fieldset', right: 'Agrupación lógica de campos' }, { left: 'aria-describedby', right: 'Contexto adicional de ayuda/error' }], exp: 'La accesibilidad en formularios depende de estructura semántica.' }] },
        { title: 'SEO técnico y calidad estructural', questions: [{ type: 'choice', q: '¿Qué práctica impacta directamente indexación y comprensión temática?', opts: ['Usar múltiples h1 sin criterio', 'Title y headings alineados a intención de búsqueda', 'Eliminar meta description siempre', 'Ocultar todo texto en imágenes'], ans: 1, exp: 'Coherencia semántica ayuda a motores y usuarios.' }, { type: 'truefalse', q: 'Un HTML semántico y liviano contribuye al rendimiento percibido.', ans: true, exp: 'Estructura limpia facilita parseo y render.' }, { type: 'match', q: 'Relaciona señal técnica y efecto SEO:', pairs: [{ left: 'Meta description clara', right: 'Mejor contexto en resultados' }, { left: 'Encabezados ordenados', right: 'Comprensión jerárquica del contenido' }, { left: 'Imágenes optimizadas', right: 'Carga más rápida de página' }, { left: 'Landmarks semánticos', right: 'Mayor accesibilidad estructural' }], exp: 'SEO técnico y accesibilidad se refuerzan mutuamente.' }] },
      ],
      examSections: [
        { title: 'Construcción de página corporativa', questions: [{ type: 'choice', q: 'Debes publicar una landing accesible y orientada a conversión. ¿Qué orden de trabajo es más sólido?', opts: ['Diseñar estilos primero sin estructura', 'Definir estructura semántica, luego contenido, luego optimización técnica', 'Pegar HTML generado automático sin revisión', 'Priorizar animaciones sobre contenido'], ans: 1, exp: 'Una base semántica facilita accesibilidad, SEO y mantenimiento.' }, { type: 'truefalse', q: 'Si los formularios no tienen labels visibles o equivalentes, aumentan errores de usuario.', ans: true, exp: 'La falta de contexto afecta finalización del formulario.' }, { type: 'match', q: 'Relaciona revisión y objetivo:', pairs: [{ left: 'Validador HTML', right: 'Detectar estructura inválida' }, { left: 'Prueba con teclado', right: 'Verificar navegación accesible' }, { left: 'Auditoría de metadatos', right: 'Mejorar descubribilidad' }, { left: 'Optimización de medios', right: 'Reducir tiempos de carga' }], exp: 'La calidad final depende de controles técnicos concretos.' }] },
        { title: 'Gobernanza de calidad web', questions: [{ type: 'choice', q: 'En mantenimiento continuo, ¿qué práctica reduce regresiones estructurales?', opts: ['Editar directamente producción sin revisión', 'Usar checklist semántico y revisión por pares', 'Eliminar documentación del markup', 'Mezclar estructura con scripts embebidos extensos'], ans: 1, exp: 'La estandarización evita degradación progresiva.' }, { type: 'truefalse', q: 'Un heading mal jerarquizado puede afectar tanto accesibilidad como SEO.', ans: true, exp: 'Ambos sistemas dependen de estructura clara.' }, { type: 'match', q: 'Relaciona riesgo y mitigación:', pairs: [{ left: 'Contenido sin contexto', right: 'Encabezados y landmarks correctos' }, { left: 'Campos ambiguos', right: 'Labels y mensajes de error claros' }, { left: 'Carga lenta', right: 'Optimización de recursos multimedia' }, { left: 'Semántica inconsistente', right: 'Guía de marcado compartida' }], exp: 'La gobernanza técnica sostiene calidad a largo plazo.' }] },
      ],
    },
    css: {
      title: 'CSS',
