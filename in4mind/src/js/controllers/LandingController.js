...
const LandingController = (() => {
  ...
  function _bindThemeToggle() {
    const actions = document.querySelector('.lp-header__actions');
    if (!actions || actions.querySelector('[data-lp-theme]')) return;
    const btn = document.createElement('button');
    btn.type = 'button';
    btn.className = 'lp-icon-btn';
    btn.setAttribute('data-lp-theme', '1');

    function _sync() {
      const dark = typeof ThemeController !== 'undefined' && ThemeController.getTheme() === 'dark';
      btn.setAttribute('aria-label', _t(dark ? 'theme.toLight' : 'theme.toDark', null, dark ? 'Cambiar a modo claro' : 'Cambiar a modo oscuro'));
      btn.innerHTML = dark
        ? `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>`
        : `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/></svg>`;
    }
