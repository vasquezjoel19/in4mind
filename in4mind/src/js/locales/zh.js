...
const LOCALE_ZH = {
  ...
  auth: {
    ...
    resendDone: '邮件已重新发送，请查收。',
    resendFail: '发送失败，请几分钟后再试。',
  ...
  adaptive: {
    ...
    graphTitle: '掌握地图',
    graphAria: '掌握地图',
    graphEmpty: '暂无数据：完成一次快速检查即可看到你的地图。',
    graphCourse: '课程',
    graphStateMastered: '已掌握',
    graphStateProgress: '进行中',
    graphStateGap: '需要强化',
    graphMastered: '已掌握：答对 {n} 题，共 {total} 题。',
    graphProgress: '进行中：答对 {n} 题，共 {total} 题。',
    reinforceDone: '明白了',
