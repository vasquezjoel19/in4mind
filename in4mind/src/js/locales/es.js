...
const LOCALE_ES = {
  ...
  ai: {
    ...
    errTooFast: '**Vas muy rápido**\n\nEspera {wait} antes de enviar otra consulta. El límite protege el servicio para todos.',
    errDailyQuota: '**Límite diario alcanzado**\n\nHas usado tus {limit} consultas de hoy. Podrás seguir en {wait}. Mientras tanto, los cursos y quizzes siguen disponibles.',
    waitSeconds: '{n} segundos',
    waitMinutes: '{n} minutos',
    waitHours: '{n} horas',
