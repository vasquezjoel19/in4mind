...
const LOCALE_ES = {
  ...
  auth: {
    ...
    resendDone: 'Correo reenviado. Revisa tu bandeja.',
    resendFail: 'No se pudo reenviar. Inténtalo en unos minutos.',
  ...
  adaptive: {
    ...
    graphEmpty: 'Aún no hay datos: completa alguna comprobación para ver tu mapa.',
    graphCourse: 'Curso',
    graphStateMastered: 'dominado',
    graphStateProgress: 'en progreso',
    graphStateGap: 'necesita refuerzo',
    graphMastered: 'Dominado: {n} de {total} aciertos.',
    graphProgress: 'En progreso: {n} de {total} aciertos.',
