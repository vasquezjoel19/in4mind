/*! IN4MIND bundle 20260821ux1 — 2026-08-21T20:48:37.331488+00:00 */
...
const LOCALE_ES = {
  ...
  notes: {
    ...
    deleteFolderConfirm: '¿Eliminar esta carpeta y todas las notas que contiene? Las notas fuera de la carpeta no se borran. Tendrás unos segundos para deshacer.',
  ...
  projects: {
    ...
    emptyConfirm: '¿Quitar todas las tareas de este proyecto?',
    emptied: 'Proyecto vaciado',
...
const LOCALE_EN = {
  ...
  notes: {
    ...
    deleteFolderConfirm: 'Delete this folder and all notes inside it? Notes outside the folder are kept. You will have a few seconds to undo.',
    folderRenamed: 'Folder renamed',
    folderDeleted: 'Folder and its notes deleted',
    folderDeletedUndo: 'Folder deleted',
    deletedUndo: 'Note deleted',
    moveToFolder: 'Move to folder',
    moveShort: 'Move',
    noFolderShort: 'No folder',
    moved: 'Note moved',
  ...
  projects: {
    ...
    emptyProject: 'Clear project',
    emptyConfirm: 'Remove all tasks from this project?',
    emptied: 'Project cleared',
    ...
    emptyArchived: 'Projects you archive will appear here.',
  },
  guided: {
...
const LOCALE_ZH = {
  ...
  notes: {
    ...
    renameFolder: '重命名',
    folderOptions: '文件夹选项',
    deleteFolderConfirm: '删除此文件夹及其内的所有笔记？文件夹外的笔记会保留。你有几秒钟可以撤销。',
    folderRenamed: '文件夹已重命名',
    folderDeleted: '文件夹及其笔记已删除',
    folderDeletedUndo: '文件夹已删除',
    deletedUndo: '笔记已删除',
    moveToFolder: '移到文件夹',
    moveShort: '移动',
    noFolderShort: '无文件夹',
  ...
  projects: {
    ...
    showActive: '查看进行中',
    archivedBadge: '已归档',
    emptyArchivedTitle: '没有已归档项目',
    emptyArchived: '你归档的项目会出现在这里。',
  },
  guided: {
    pageTitle: '引导项目',
