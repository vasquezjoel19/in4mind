...
const LOCALE_EN = {
  ...
  auth: {
    ...
    resendFail: 'Could not resend. Try again in a few minutes.',
  ...
  cert: {
    ...
    verifyPageTitle: 'Verify certificate — IN4MIND',
    verifySub: 'Enter the IN4MIND certificate code.',
  ...
  tutorial: {
    ...
    previewBannerEnd: 'to save your progress.',
    thumbsDown: 'Not helpful',
    thumbsUp: 'Helpful',
    wasUseful: 'Was this helpful?',
  },
  share: {
  ...
  quizzes: {
    ...
    timeUp: 'Time is up. Showing results.',
  },
  ai: {
    ...
    error: 'Request error',
    infyAlt: 'Infy, the IN4MIND assistant',
  ...
  adaptive: {
    ...
    graphEmpty: 'No data yet: complete a quick check to see your map.',
    graphCourse: 'Course',
    graphStateMastered: 'mastered',
    graphStateProgress: 'in progress',
    graphStateGap: 'needs reinforcement',
    graphMastered: 'Mastered: {n} of {total} correct.',
    graphProgress: 'In progress: {n} of {total} correct.',
  ...
  settingsModal: {
    ...
    onboardReset: 'Tour reset. Go to the dashboard.',
    resetOnboard: 'Replay welcome tour',
    adaptive: 'Adaptive learning',
    adaptiveHint: 'Short checks while you study, plus reinforcement for what you miss. Off by default.',
    saveName: 'Save',
    weeklyGoals: 'Weekly goals',
    weeklyGoalsHint: 'Lessons and quizzes per week.',
  },
  cookies: {
    bannerTitle: 'Cookies',
